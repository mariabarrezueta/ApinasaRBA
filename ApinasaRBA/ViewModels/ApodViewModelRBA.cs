...
namespace ApinasaRBA.ViewModels
{
    public class ApodViewModelRBA : INotifyPropertyChanged

    {
        ...
        private ApodServiceRBA service;
        public ApodServiceRBA Service
        {
            get
            {
                if (service == null)
                {
                    service = new ApodServiceRBA();
                }
                return service;
            }
        }
        ...
        {
            ApodRBA dto = await Service.GetImage(day);
            if (dto == null)
            {
